...
# KUPINET TRADING MANUAL
**[ens://kupinet.eth](https://etherscan.io/address/kupinet.eth)**

---
### TO SELL ERC20 TOKENS ON KUPINET:

#### 1. Approve your ERC20 tokens.
**DO NOT TRANSFER TOKENS TO KUPINET!** Just execute **approve()** method on contract of the token you want to trade. You can check the tradable amount of a token by calling **balanceApprovedForToken()** method on KUPINET contract.
...
#### 2. There are two ways to sell tokens on KUPINET:
---
### 2.1. Place sell order on KUPINET  (FREE)
...
### TO BUY ERC20 TOKENS ON KUPINET:

#### 1. There are few ways to deposit ether to KUPINET contract.
 * Sending it to the contract;
 * Calling **deposit()** method;
 * Adding value to **willbuy()** or **buy()** method.

#### 2. There are two ways to buy tokens on KUPINET:
---
### 2.1. Place buy order on KUPINET  (FREE)
...
### FEES:
Placing orders is free on KUPINET.  Using methods **buy()** or **sell()** is free for any address for the 1st time. Trading amounts < 0.001 ether is free. KUPINET has fixed fee of 0.0001 ether for trading amounts over 0.001 ether (except for the first trade). One can refund 0.0003 ether to **frontend_refund address** in **buy()** and **sell()** methods.

---

**[KUPINET on Ethereum mainnet](https://etherscan.io/address/kupinet.eth)**

**[KUPINET on ropsten](https://ropsten.etherscan.io/address/0x4D32DECe5810e15164c36E91d62cE6B16Df4F747)**
### KUPINET abi:
```js
