/*
   KUPINET DAO              Source code available under GPLv2 license
                          2018  Kupi.net
*/
...
contract KupinetDAO {
  address public kupinet = 0xC9d78ebd4D11d0Dd6FE16953EfE6534A2cc0A9c7;
  ...
  function name() constant public returns (string) {
    return "KUPINET OWNERSHIP TOKEN";
  }
  ...
  function withdraw() public {
    uint256 b = Kupinet(kupinet).balanceOf(address(this));
    uint256 totalShares;
    uint256 i;
    while (owners[i] != 0) {
